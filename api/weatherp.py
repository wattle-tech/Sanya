...
plusfive = ["лучше одется потеплее", "накиньте что нибудь", "одевайтесь потеплее", "холодновато", "холодновато, не находите?"]
